    ...
    public function onDisplay(Request $request)
    {
        $columns = [
            ...
            AdminColumn::custom('url', function($model) {
                return '<span class="copy-me">'.route('vacancies.page', trim($model->slug, '/')).'</span>';
        ...
        $form = AdminForm::card()->addBody([
            AdminFormElement::columns()
                ->addColumn([
                    ...
                    AdminFormElement::textarea('short_text', 'Краткое описание')->required(),
                    AdminFormElement::textarea('full_text', 'Полное описание')->required()->setHtmlAttribute('class', 'tinymce_full'),
